...
public class ScreenUtils {
    ...
    public static int getScreenWidth() {
        return MyApplication.getInstance().getContext().getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return MyApplication.getInstance().getContext().getResources().getDisplayMetrics().heightPixels;
    }
    ...
    public static float dpToPx(float dp) {
        return dp * MyApplication.getInstance().getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / MyApplication.getInstance().getContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / MyApplication.getInstance().getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * MyApplication.getInstance().getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = MyApplication.getInstance().getContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
