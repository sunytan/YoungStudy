package ty.youngstudy.com.yuxin.session;
...
import ty.youngstudy.com.yuxin.session.extension.StickerAttachment;
import ty.youngstudy.com.yuxin.session.search.SearchMessageActivity;
...
public class SessionHelper {
    ...
    public static void init() {
        ...
        // TODO: 2017/12/27  NimUIKit.setCommonTeamSessionCustomization(getTeamCustomization());
    ...
    public static void startTeamSession(Context context, String tid, Class<? extends Activity> backToClass, IMMessage anchor) {
        // TODO: 2017/12/27  NimUIKit.startChatting(context, tid, SessionTypeEnum.Team, getTeamCustomization(), backToClass, anchor);
    }
...
/*            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            SessionCustomization.OptionsButton cloudMsgButton = new SessionCustomization.OptionsButton() {
                ...
                public void onClick(Context context, View view, String sessionId) {
                    // TODO: 2017/12/27  initPopuptWindow(context, view, sessionId, SessionTypeEnum.P2P);
                }
            };
            ...
            public void onAvatarClicked(Context context, IMMessage message) {
                ...
                if (message.getMsgType() == MsgTypeEnum.robot && message.getDirect() == MsgDirectionEnum.In) {
                    ...
                    if (attachment.isRobotSend()) {
                        // TODO: 2017/12/27  RobotProfileActivity.start(context, attachment.getFromRobotAccount());
                        return;
                    }
                }
                // TODO: 2017/12/27  UserProfileActivity.start(context, message.getFromAccount());
            }
        ...
        public void onItemClick(final PopupMenuItem item) {
            switch (item.getTag()) {
                case ACTION_HISTORY_QUERY:
                    // TODO: 2017/12/27 历史消息 MessageHistoryActivity.start(item.getContext(), item.getSessionId(), item.getSessionTypeEnum()); // 漫游消息查询
                    break;
