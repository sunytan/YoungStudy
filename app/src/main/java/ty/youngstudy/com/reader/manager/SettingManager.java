...
import ty.youngstudy.com.reader.BookMark;
...
public class SettingManager {
    ...
    public int getReadBrightness() {
        return SharedPreferencesUtil.getInstance().getInt(getLightnessKey(),
                (int) ScreenUtils.getScreenBrightness(MyApplication.getInstance().getContext()));
    }
    ...
    public void saveReadTheme(int theme) {
        SharedPreferencesUtil.getInstance().putInt(NovelConstant.READ_THEME, theme);
    }
    ...
    public int getReadTheme() {
        ...
        return SharedPreferencesUtil.getInstance().getInt(NovelConstant.READ_THEME, 3);
    }
    ...
    public String getUserChooseSex() {
        return SharedPreferencesUtil.getInstance().getString("userChooseSex", NovelConstant.Gender.MALE);
    }
